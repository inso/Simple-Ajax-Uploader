    ...
    ss.extendObj( ss.SimpleUpload.prototype, {
        ...
        */
        _checkFile: function( fileObj ) {
            var extOk = false,
                i = this._opts.allowedExtensions ? this._opts.allowedExtensions.length : 0;
            ...
            if ( i > 0 ) {
                ...
                if ( !extOk ) {
                    ...
                    this._opts.onExtError.call( this, fileObj.name, fileObj.ext, this._opts.allowedExtensions );
                    return false;
                }
            }
                ...
                fileObj.size > this._opts.maxSize )
            {
                ...
                this._opts.onSizeError.call( this, fileObj.name, fileObj.size, this._opts.maxSize );
                return false;
            }
